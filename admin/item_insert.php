<h1 align="center">Add Item Form</h1>
<form action="item_insert_info.php"  method="post" enctype="multipart/form-data" class="heightconfig">
<table align="center">
	<tr>
		<td>Select Brand:</td>
		<td>
    ...
    <tr>
		...
		<td>
			<input type="text" name="qty" size="18" />
		</td>
	</tr>
	<tr>
		<td>
